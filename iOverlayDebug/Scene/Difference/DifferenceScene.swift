...
final class DifferenceScene: ObservableObject, SceneContainer {
    ...
    func makeView() -> DifferenceSceneView {
        DifferenceSceneView(scene: self)
    }
    ...
    func solve() {
        ...
        let list = overlay.buildGraph(fillRule: rule).extractShapes(overlayRule: .difference)
