...
final class SubjScene: ObservableObject, SceneContainer {
    ...
    func makeView() -> SubjSceneView {
        SubjSceneView(scene: self)
    }
    ...
    func solve() {
        ...
        let list = overlay.buildGraph(fillRule: rule).extractShapes(overlayRule: .subject)
